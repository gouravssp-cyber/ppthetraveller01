...
@section('title', 'Domestic Tour Packages')
@section('meta_description', 'Explore amazing domestic tour packages across India')
...
<section class="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            <span class="text-white block mb-2">Discover</span>
            <span class="bg-gradient-to-r from-yellow-accent via-orange-primary to-yellow-accent bg-clip-text text-transparent">Incredible India</span>
        </h1>
        <p class="text-lg md:text-xl text-white/90 mb-8 font-light max-w-3xl mx-auto leading-relaxed">
            Explore curated domestic tour packages across India's most breathtaking destinations
        </p>
    </div>
</section>
    ...
    <section class="py-16 px-4 md:px-8 bg-gray-50">
        <div class="max-w-7xl mx-auto text-center">
            <div class="bg-white rounded-2xl p-12 shadow-lg">
                ...
                <h3 class="text-2xl font-bold text-title mb-2">No Domestic Packages Available</h3>
                <p class="text-body-text">Check back soon for exciting domestic tour packages!</p>
            </div>
        </div>
    </section>
@endif
